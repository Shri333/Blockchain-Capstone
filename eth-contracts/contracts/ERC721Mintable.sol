...
contract Ownable {
    ...
    function transferOwnership(address newOwner) public onlyOwner {
        ...
        require(
            ...
            "New owner is not a real address"
        );
...
contract ERC721 is Pausable, ERC165 {
    ...
    function approve(address to, uint256 tokenId) public whenNotPaused {
        ...
        require(
            ...
            "Other address cannot be owner of token"
        );
        ...
        require(
            ...
            "Other address is not authorized to transfer tokens on your behalf"
        );
    ...
    function _mint(address to, uint256 tokenId) internal {
        ...
        require(
            to == address(to) && !_exists(tokenId),
            "Address is invalid or token already exists"
        );
    ...
    function _transferFrom(
        ...
        require(to == address(to), "To address is not valid");
        // TODO: clear approval
